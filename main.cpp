...
bool BTree::add_word_to_tree(string word) //from word vector
{
    int i;
    BTreeNode *ptr=Root;
    for(i=0;i<word.length();i++)
...
int main()
{
    ...
    cout<<"If you get two ones, then the tree is ccorrectly set up and populated " <<endl;
    cout<<"Is the word correctly added? "<<test->add_word_to_tree("RYRY")<<endl;
    cout<<"Is the word in the tree? "<<test->is_word_in_tree("RYRY")<< endl;
    ...
    cout<<"This sequence should not be in the tree..." <<test->is_word_in_tree("RYRYRY")<<endl;
    cout<<"The output should be 1 because we added RYRYRY to the tree..."<<test->add_word_to_tree("RYRYRY")<<endl;
    cout<<"Check to see if RYRYRY is there..."<<test->is_word_in_tree("RYRYRY")<< endl;
    cout <<"We are adding the same word to repeat test..." <<test->is_word_in_tree ("RYRYRY")<<endl;
